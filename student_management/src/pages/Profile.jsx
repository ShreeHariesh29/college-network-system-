...
function Photo() {
  return (
    <div className='bg-slate-200 pt-[2px] pb-[2px] flex w-full'>
    <div className='mt-[15px] '>
    <div className='h-[350px] w-[350px] shadow-lg drop-shadow-2xl bg-white shadow-gray-500 border-2 rounded-2xl  ml-[15px]'> 
   <img className='h-[150px] pt-[10px] pl-[35px]' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvYXb7VlC1YgBNOnhPjKpuKMSiktqezTZz5A&usqp=CAU" alt="hi" />
...
<div className='h-[210px] w-[350px] shadow-lg drop-shadow-2xl bg-white shadow-gray-500 border-2 rounded-2xl mt-[25px] ml-[15px]'>
   ...
   <div>
   <div className='h-[575px] w-[950px] shadow-lg drop-shadow-2xl bg-white shadow-gray-500 border-2 rounded-2xl mt-[15px] ml-[15px]'>
